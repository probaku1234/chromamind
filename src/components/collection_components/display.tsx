...
export const NoDataDisplay = ({
  ...
  message = 'No embeddings have been added yet.',
}: {
  title?: string
  message?: string
}) => (
  ...
  >
    ...
    <Text fontSize="lg" fontWeight="600" color="gray.500" mb={1}>
      {title}
    </Text>
...
export const ErrorDisplay = ({
  ...
  <Flex
    ...
    h="100%"
  >
    <Box bg="red.100" borderRadius="xl" p={3} mb={4} color="red.500">
      <XIcon />
    </Box>
    <Text fontSize="md" fontWeight="700" color="gray.900" mb="6px">
