    ...
    <Box bg="gray.50" h="100%" id="root" p={4} overflowY="auto">
      ...
      <Section label="Buttons">
        <Flex gap={2} flexWrap="wrap">
          ...
          <Button size="sm" buttonType="critical">
            Delete
          </Button>
        </Flex>
      </Section>
      ...
      <Section label="Nav item">
        <Box css={layoutCollectionNavStyles}>
          ...
          >
            ...
            <Text fontSize="12px" fontWeight="500" color="brand.800" flex={1}>
              Collections
            </Text>
          ...
          >
            {[
              ...
              <Text
                ...
                flex={1}
                fontFamily={
                  i === 0 || i === 2 ? "'JetBrains Mono', monospace" : undefined
                }
              >
                {v}
              </Text>
      ...
      <Section label="Error state">
        <Flex direction="column" align="center" py={3} gap={2}>
          ...
          <Text fontSize="11px" color="gray.400" textAlign="center">
            Could not connect to ChromaDB at localhost:8000
          </Text>
