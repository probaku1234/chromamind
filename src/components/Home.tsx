...
const StatCard = ({ label, value }: StatCardProps) => (
  <Box
    ...
    py={5}
  >
    <Text fontSize="xs" color="gray.400" fontWeight="500" mb={1}>
      {label}
    </Text>
    <Box
      fontSize="4xl"
    ...
    <Box p={7} overflowY="auto" h="100%" bg="firstBg">
      ...
      >
        <Flex align="center" gap={3} mb={2}>
          ...
          <Text fontSize="15px" fontWeight="600" color="gray.950">
            {url}
          </Text>
        </Flex>
        {tenant && (
      ...
      <Grid templateColumns="repeat(3, 1fr)" gap={3} mb={4}>
        ...
        >
          <Text fontSize="xs" color="gray.400" fontWeight="500" mb={3}>
            Connection
          </Text>
      ...
      <Box
        ...
        py={4}
      >
        <Text fontSize="13px" fontWeight="600" color="gray.950" mb={3}>
          Quick Actions
        </Text>
        <Flex gap={2}>
